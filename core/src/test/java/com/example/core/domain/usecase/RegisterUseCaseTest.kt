...
class RegisterUseCaseTest {
    ...
    fun setUp() {
        ...
        registerUseCase = RegisterUseCase(authRepository, messagingRepository)
    }
    ...
    fun `invoke should emit Loading and Success`() = runTest {
        ...
        coEvery {
            authRepository.register(AuthRequest(email, password, token))
        } returns flowOf(EcommerceResponse.Success("Success"))
        ...
        result.test {
            ...
            assertEquals(EcommerceResponse.Success("Success"), success)
            awaitComplete()
        }
