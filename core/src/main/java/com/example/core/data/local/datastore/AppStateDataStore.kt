...
class AppStateDataStore @Inject constructor(
    ...
    companion object {
        ...
        private val LANGUAGE_STATE_KEY = stringPreferencesKey("language")
    }
    ...
    suspend fun setLanguageCode(languageCode: String) {
        dataStore.edit { it[LANGUAGE_STATE_KEY] = languageCode }
    }

    fun getLanguageCode(): Flow<String> = dataStore.data
        .catch { emit(emptyPreferences()) }
        .map { it[LANGUAGE_STATE_KEY] ?: "en" }
